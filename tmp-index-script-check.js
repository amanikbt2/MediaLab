    ...
    `,
      ...
      function canAdvanceMarketplaceStep(step = marketplaceCreateStep) {
        if (Number(step) === 1) {
          return getMarketplaceValidationIssues().every(
            (issue) =>
              ![
                ...
                "Terminate and package the live project before listing it.",
              ].includes(issue),
          );
        }
        if (Number(step) === 2) {
        ...
        if (Number(step) === 3) {
          return !getMarketplaceValidationIssues().includes("Upload 4 preview images.");
        }
        return false;
      }
