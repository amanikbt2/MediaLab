 ...
 * Verifies: parseAdvancedAnimation → generateAnimationCSS → generateSmartCanvasElementSpec
 */
...
// Execute in VM context to create global WorkflowBrain
const vm = require("vm");
...
console.log("\nGenerated keyframes:");
console.log(keyframes.substring(0, 150) + "...");
console.log("");
