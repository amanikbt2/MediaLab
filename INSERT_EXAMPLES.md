# 🎨 AI Insert Examples - Quick Reference
...
- `insert a glowing submit button with glow effect and text "Submit"`
- `insert a purple button with gradient and rounded edges`
...
- `insert a large card with gradient background and glow`
- `insert a container with rounded edges and border`
...
- `insert a spinning loader with pulsing animation`
...
- `insert a large rounded container with shadow`
...
- `insert a rainbow gradient circle with pulsing glow`
...
- ✅ Ready-to-edit in the canvas
- ✅ Code synced to editor

## Pro Tips

1. **Be Descriptive:** "glowing button" vs "intense neon cyan button with rounded edges"
2. **Combine Effects:** Mix glow + animation + gradient
3. **Specify Size:** tiny, small, medium, large, huge, 2xl, 3xl
4. **Add Text:** "with text 'Hello'" or "says 'Click Me'"
...
- **Decorations:** border, outline, frame, edge
- **Glass:** frosted, blur, transparent, glass
- **Animations:** spin, bounce, pulse, float, wave, shake
...
insert a large bouncing ball with pulsing glow animation
insert a hero section with gradient background and glowing call-to-action
```
...
The system is flexible enough to create whatever you need:

1. **Start simple:** `insert button`
2. **Add complexity:** `insert large glowing button`
3. **Add effects:** `insert large glowing cyan button with intense glow`
4. **Add animation:** `insert large glowing cyan button with intense glow and bounce`

**It just works! 🚀**

Try combining different effects and descriptions - the more specific you are, the better!
